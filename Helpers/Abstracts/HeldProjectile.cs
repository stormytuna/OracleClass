...
/// <summary>
///     This is a helper class to make creating and handling held projectile weapons.
///     <para />
///     All this class will handle for you is how the projectile appears and soul draining while you channel the item
///     <para />
///     This class also contains a frame counter property that's already set up for you, no need to use the <c>frameCount</c> field or create your own. It also doesn't use any ai fields, so you can use
///     those for whatever you want
///     <para />
...
///         </item>
///         <item>
///             <term>UseTimeOverride</term><description> Setting this will make the projectile treat that new value as the base useTime of the weapon</description>
///         </item>
///     </list>
...
///     <list type="bullet">
///         <item>
///             <term>AI</term><description> Handles losing soul from your item, projectile direction, location and rotation and sets some values on the player</description>
///         </item>
///         <item>
...
///     <list type="bullet">
///         <item>
///             <term>OnUseItem</term><description> This is called each time the projectile consumes some soul</description>
///         </item>
///         <item>
///             <term>OnFinishedCharging</term>
///             <description> This is called when the projectile is finished channelling, either from the player letting go or running out of soul. It has a total soul consume parameter</description>
///         </item>
///     </list>
/// </summary>
...
public abstract class HeldProjectile : ModProjectile
{
	...
	private int UseTimeAfterBuffs => (int)(UseTimeOverride / Owner.GetWeaponAttackSpeed(Owner.HeldItem));

	// This is a counter that just keeps track of taking away our soul
	private int _soulConsumeCooldown;

	// This counter keeps track of how much soul this projectile has consume
	private int _totalSoulConsumed;
	...
	public override void AI() {
		...
		if (_soulConsumeCooldown <= 0) {
			...
			OracleWeapon heldOracleWeapon = Owner.HeldItem.GetOracleWeapon();
