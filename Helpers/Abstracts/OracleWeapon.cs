...
/// <summary>
///     This is a helper class to make creating and handling oracle weapons easier.
///     <para />
///     Be sure to set these properties in the SetDefaults hook
///     <para />
///     <list type="bullet">
///         <item>
///             <term>OracleType</term><description> The type of oracle weapon, either Focus, Cane or Glyph</description>
///         </item>
///         <item>
///             <term>BaseSoulCapacity</term><description> The base soul capacity of this weapon</description>
///         </item>
///         <item>
///             <term>SoulRecoveryFrames</term><description> The amount of frames it takes to go from 0 soul capacity to max soul capacity, not including cooldown frames from exhausting</description>
///         </item>
///         <item>
///             <term>HandleSoulConsumption</term><description> Whether or not this item will handle soul consumption for us. Set this to false for held projectile weapons</description>
///         </item>
///     </list>
...
///     <list type="bullet">
///         <item>
///             <term>CanUseItem</term><description> Checks if this weapon is exhausted</description>
///         </item>
///         <item>
///             <term>UseItem</term><description> Handles current soul capacity being reduced and the weapon being exhausted if applicable</description>
///         </item>
///         <item>
///             <term>UpdateInventory</term><description> Handles soul recovery and soul recovery cooldown</description>
///         </item>
///         <item>
///             <term>ModifyTooltips</term><description> Handles displaying "X/Y soul capacity" and "+|- Z% soul capacity" tooltips</description>
///         </item>
///         <item>
///             <term>Clone</term><description> Handles instanced modded data being persistent between clones of the same item</description>
///         </item>
///         <item>
///             <term>SaveData and LoadData</term><description> Handles saving and loading of instanced modded data on this item</description>
///         </item>
///     </list>
/// </summary>
public abstract class OracleWeapon : ModItem
{
	...
	public int MaxSoulCapacity => (int)(BaseSoulCapacity * SoulCapacityMultiplierFromPrefix * Main.LocalPlayer.GetModPlayer<OraclePlayer>().SoulCapacityMultiplier);
	...
	public float CurSoulCapacityNormalized => CurSoulCapacity / (float)MaxSoulCapacity;
	...
	public int SoulRecoveryCooldown { get; set; }
	...
	public override void UpdateInventory(Player player) {
		...
		if (SoulRecoveryCooldown <= 0 && CurSoulCapacity < MaxSoulCapacity) {
			...
			if (_soulRecovery < (int)(CurSoulCapacityNormalized * SoulRecoveryFrames)) {
				_soulRecovery = (int)(CurSoulCapacityNormalized * SoulRecoveryFrames);
			}
			...
			if (CurSoulCapacity < (int)(_soulRecovery / (float)SoulRecoveryFrames * MaxSoulCapacity)) {
				CurSoulCapacity = (int)(_soulRecovery / (float)SoulRecoveryFrames * MaxSoulCapacity);
			}
	...
	public override int ChoosePrefix(UnifiedRandom rand) {
		IReadOnlyList<ModPrefix> modPrefixes = PrefixLoader.GetPrefixesInCategory(PrefixCategory.Custom);
		...
		foreach (ModPrefix modPrefix in modPrefixes) {
	...
	public override void ModifyTooltips(List<TooltipLine> tooltips) {
		...
		if (SoulCapacityMultiplierFromPrefix != 1f) {
			TooltipLine tooltip = tooltips.FindLast(tip => tip.Name.StartsWith("Prefix"));
